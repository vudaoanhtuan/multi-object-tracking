"""Generalized Motion Compensation (GMC) class for tracking in video frames."""
...
class GMC:
    ...
    Supports tracking algorithms including ORB, SIFT, ECC, and Sparse Optical Flow.
    """

    def __init__(self, method: str = "sparseOptFlow", downscale: int = 2) -> None:
        """Initialize a GMC object with tracking method and downscale factor."""
        super().__init__()
    ...
    def apply_ecc(self, raw_frame: np.ndarray) -> np.ndarray:
        """Apply the ECC algorithm to a raw frame for motion compensation."""
